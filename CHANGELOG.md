...
## Version 22.3.0
* Implemented the [WebAssembly multi-value](https://github.com/WebAssembly/multi-value) proposal. It can be disabled using the `--js.wasm-multi-value=false` option;
