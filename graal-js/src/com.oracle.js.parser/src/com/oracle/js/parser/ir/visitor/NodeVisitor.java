...
public abstract class NodeVisitor<T extends LexicalContext> {
     ...
     * @return true if traversal should continue and node children be traversed, false otherwise
     */
    public boolean enterClassElement(final ClassElement element) { return enterDefault(element); }
     ...
     * @return processed node, which will replace the original one, or the original node
     */
    public Node leaveClassElement(final ClassElement element) { return leaveDefault(element); }
}
