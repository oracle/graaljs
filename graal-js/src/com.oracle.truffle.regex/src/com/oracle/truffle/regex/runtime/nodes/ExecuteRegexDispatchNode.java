...
import com.oracle.truffle.regex.HasCompiledRegex;
...
public abstract class ExecuteRegexDispatchNode extends Node {
    ...
    public abstract RegexResult execute(HasCompiledRegex receiver, Object input, Object fromIndex);

    @Specialization(guards = "receiver == cachedReceiver", limit = "4")
    public RegexResult doCached(HasCompiledRegex receiver, Object input, Object fromIndex,
                    ...
                    @SuppressWarnings("unused") @Cached("receiver") HasCompiledRegex cachedReceiver,
                    @Cached("create(cachedReceiver.getCompiledRegex().getRegexCallTarget())") DirectCallNode directCallNode) {
    ...
    public RegexResult doUnCached(HasCompiledRegex receiver, Object input, Object fromIndex,
                    @Cached("create()") ExpectStringOrTruffleObjectNode expectStringOrTruffleObjectNode,
                    @Cached("create()") ExpectNumberNode expectNumberNode,
        ...
        return (RegexResult) indirectCallNode.call(receiver.getCompiledRegex().getRegexCallTarget(), new Object[]{receiver, unboxedInput, NumberConversion.intValue(fromIndexNumber)});
    }
