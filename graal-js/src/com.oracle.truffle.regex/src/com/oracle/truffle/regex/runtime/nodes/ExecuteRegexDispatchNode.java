...
public abstract class ExecuteRegexDispatchNode extends Node {
    ...
    public abstract RegexResult execute(RegexObject receiver, Object input, Object fromIndex);

    @Specialization(guards = "receiver == cachedReceiver", limit = "4")
    public RegexResult doCached(RegexObject receiver, Object input, Object fromIndex,
    ...
    public RegexResult doUnCached(RegexObject receiver, Object input, Object fromIndex,
                    @Cached("create()") ExpectStringOrTruffleObjectNode expectStringOrTruffleObjectNode,
                    @Cached("create()") ExpectNumberNode expectNumberNode,
