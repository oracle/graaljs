...
/**
 * Callback for dynamic import syntax (corresponds to {@code HostImportModuleDynamically}).
 */
@FunctionalInterface
public interface ImportModuleDynamicallyCallback {
     ...
     * @param moduleRequest The name of the module to be imported and its attributes.
     ...
     */
    JSDynamicObject importModuleDynamically(JSRealm realm, ScriptOrModule referrer, ModuleRequest moduleRequest);
}
