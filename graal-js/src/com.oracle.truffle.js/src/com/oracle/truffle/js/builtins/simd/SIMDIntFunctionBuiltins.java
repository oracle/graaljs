...
public class SIMDIntFunctionBuiltins extends JSBuiltinsContainer.SwitchEnum<SIMDIntFunctionBuiltins.SIMDTypeFunction> {
    public SIMDIntFunctionBuiltins(String typeName, SIMDType simdContext) {
