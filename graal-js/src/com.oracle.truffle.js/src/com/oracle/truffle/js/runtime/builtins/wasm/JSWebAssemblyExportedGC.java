...
public class JSWebAssemblyExportedGC extends AbstractJSClass implements PrototypeSupplier {
    ...
    public boolean set(JSDynamicObject thisObj, Object key, Object value, Object receiver, boolean isStrict, Node encapsulatingNode) {
        throw Errors.createTypeError("cannot set property on exported Wasm GC object", encapsulatingNode);
    }
    ...
    @Override
    @TruffleBoundary
    public List<Object> getOwnPropertyKeys(JSDynamicObject obj, boolean strings, boolean symbols) {
        return List.of();
    }
