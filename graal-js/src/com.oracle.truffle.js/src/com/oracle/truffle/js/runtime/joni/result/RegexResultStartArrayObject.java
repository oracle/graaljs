...
public final class RegexResultStartArrayObject implements TruffleObject {
    ...
    abstract static class RegexResultGetStartNode extends Node {
        ...
        static int doSingleResult(SingleResult receiver, int groupNumber,
                        @Cached("createBinaryProfile()") ConditionProfile boundsProfile) throws InvalidArrayIndexException {
