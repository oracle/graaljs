...
public abstract class JSInteropGetIteratorNode extends JSInteropCallNode {
    ...
    Object doDefault(JSObject receiver, @SuppressWarnings("unused") JavaScriptLanguage language, boolean hasIteratorMethod,
                    @Cached(value = "createGetIteratorMethod(language)", uncached = "getUncachedProperty()") PropertyGetNode iteratorPropertyGetNode,
        ...
        Object method;
        if (iteratorPropertyGetNode == null) {
            method = JSObject.getOrDefault(receiver, Symbol.SYMBOL_ITERATOR, receiver, null);
        } else {
            method = iteratorPropertyGetNode.getValueOrDefault(receiver, null);
        }
    ...
    PropertyGetNode createGetIteratorMethod(JavaScriptLanguage language) {
        return PropertyGetNode.create(Symbol.SYMBOL_ITERATOR, language.getJSContext());
    }

    PropertyGetNode getUncachedProperty() {
        return null;
    }
}
