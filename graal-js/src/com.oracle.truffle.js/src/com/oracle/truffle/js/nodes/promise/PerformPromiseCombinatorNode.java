...
public abstract class PerformPromiseCombinatorNode extends JavaScriptBaseNode {
    ...
    public abstract JSDynamicObject execute(IteratorRecord iteratorRecord, Object constructor, PromiseCapabilityRecord resultCapability, Object promiseResolve);
    ...
    protected final Object iteratorValueOrSetDone(IteratorRecord iteratorRecord, Object next) {
        Object nextValue;
        try {
            nextValue = iteratorValue.execute(next);
        } catch (Throwable error) {
            iteratorRecord.setDone(true);
            throw error;
        }
