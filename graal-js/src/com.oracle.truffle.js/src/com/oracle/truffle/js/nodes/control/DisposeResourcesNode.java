...
public final class DisposeResourcesNode extends AbstractDisposeResourcesNode {

    private DisposeResourcesNode() {
    }

    public static DisposeResourcesNode create() {
