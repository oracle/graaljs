...
public abstract class JSConstructTypedArrayNode extends JSBuiltinNode {
    ...
    protected JSDynamicObject doTypedArray(JSDynamicObject newTarget, JSTypedArrayObject arrayBufferView, Object byteOffset0, Object length0,
        ...
        long length = sourceLengthNode.execute(node, arrayBufferView, getContext());
        ...
        JSDynamicObject result = createTypedArray(targetArrayBuffer, targetType, 0, (int) length, proto);
        ...
        if (bulkCopyProfile.profile(node, !sourceType.isInterop() && sourceType.getFactory() == targetType.getFactory())) {
