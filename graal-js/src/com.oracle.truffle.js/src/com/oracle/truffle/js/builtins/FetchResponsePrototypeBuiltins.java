...
import com.oracle.truffle.js.builtins.FetchResponsePrototypeBuiltinsFactory.JSFetchResponseValueOfNodeGen;
...
public final class FetchResponsePrototypeBuiltins extends JSBuiltinsContainer.SwitchEnum<FetchResponsePrototypeBuiltins.FetchResponsePrototype> {
    ...
    protected Object createNode(JSContext context, JSBuiltin builtin, boolean construct, boolean newTarget, FetchResponsePrototype builtinEnum) {
        switch (builtinEnum) {
            case valueOf:
                return JSFetchResponseValueOfNodeGen.create(context, builtin, args().withThis().createArgumentNodes(context));
        }
        return null;
    }
    ...
    public abstract static class JSFetchResponseValueOfNode extends JSFetchResponseOperation {

        public JSFetchResponseValueOfNode(JSContext context, JSBuiltin builtin) {
            super(context, builtin);
        }

        @Specialization
        protected double doOperation(Object thisResponse) {
            return 1.0;
        }
    }
}
