...
public class TemporalZonedDateTimePrototypeBuiltins extends JSBuiltinsContainer.SwitchEnum<TemporalZonedDateTimePrototypeBuiltins.TemporalZonedDateTimePrototype> {
    ...
    public abstract static class JSTemporalZonedDateTimeWith extends JSTemporalBuiltinOperation {
        ...
        public Object with(Object thisObj, Object temporalZonedDateTimeLike, Object optionsParam,
            ...
            List<TruffleString> fieldNames = TemporalUtil.calendarFields(getContext(), calendar, TemporalUtil.listDHMMMMMNSY);
            ...
            JSTemporalDateTimeRecord dateTimeResult = TemporalUtil.interpretTemporalDateTimeFields(calendar, fields, options, getOptionNode);
            ...
            return JSTemporalZonedDateTime.create(getContext(), epochNanoseconds, timeZone, calendar);
        }
    }
    ...
    public abstract static class JSTemporalZonedDateTimeWithPlainTime extends JSTemporalBuiltinOperation {
        ...
        public DynamicObject withPlainTime(Object thisObj, Object plainTimeLike,
            ...
            JSTemporalPlainDateTimeObject resultPlainDateTime = JSTemporalPlainDateTime.create(getContext(), plainDateTime.getYear(), plainDateTime.getMonth(), plainDateTime.getDay(),
                            plainTime.getHour(), plainTime.getMinute(), plainTime.getSecond(), plainTime.getMillisecond(), plainTime.getMicrosecond(), plainTime.getNanosecond(), calendar, errorBranch);
    ...
    public abstract static class JSTemporalZonedDateTimeWithPlainDate extends JSTemporalBuiltinOperation {
        ...
        public DynamicObject withPlainDate(Object thisObj, Object plainDateLike,
            ...
            DynamicObject calendar = TemporalUtil.consolidateCalendars(zonedDateTime.getCalendar(), plainDate.getCalendar(), toStringNode);
    ...
    public abstract static class JSTemporalZonedDateTimeWithTimeZone extends JSTemporalBuiltinOperation {
        ...
        @Specialization
        public DynamicObject withTimeZone(Object thisObj, Object timeZoneLike,
            ...
            return JSTemporalZonedDateTime.create(getContext(), zonedDateTime.getNanoseconds(), timeZone, zonedDateTime.getCalendar());
        }
    }
    ...
    public abstract static class JSTemporalZonedDateTimeWithCalendar extends JSTemporalBuiltinOperation {
        ...
        @Specialization
        public DynamicObject withCalendar(Object thisObj, Object calendarLike,
            ...
            return JSTemporalZonedDateTime.create(getContext(), zonedDateTime.getNanoseconds(), zonedDateTime.getTimeZone(), calendar);
        }
    }
    ...
    public abstract static class JSTemporalZonedDateTimeAdd extends JSTemporalBuiltinOperation {
        ...
        @Specialization
        public DynamicObject add(Object thisObj, Object temporalDurationLike, Object optionsParam,
                        @Cached JSToStringNode toString,
                        @Cached JSNumberToBigIntNode toBigInt) {
            JSTemporalZonedDateTimeObject zonedDateTime = requireTemporalZonedDateTime(thisObj);
            JSTemporalDurationRecord duration = TemporalUtil.toLimitedTemporalDuration(temporalDurationLike, TemporalUtil.listEmpty, isObjectNode, toString, errorBranch);
            DynamicObject options = getOptionsObject(optionsParam);
            DynamicObject timeZone = zonedDateTime.getTimeZone();
            DynamicObject calendar = zonedDateTime.getCalendar();
    ...
    public abstract static class JSTemporalZonedDateTimeSubtract extends JSTemporalBuiltinOperation {
        ...
        @Specialization
        public DynamicObject subtract(Object thisObj, Object temporalDurationLike, Object optionsParam,
                        @Cached JSToStringNode toString,
                        @Cached JSNumberToBigIntNode toBigInt) {
            JSTemporalZonedDateTimeObject zonedDateTime = requireTemporalZonedDateTime(thisObj);
            JSTemporalDurationRecord duration = TemporalUtil.toLimitedTemporalDuration(temporalDurationLike, TemporalUtil.listEmpty, isObjectNode, toString, errorBranch);
    ...
    public abstract static class JSTemporalZonedDateTimeRound extends JSTemporalBuiltinOperation {
        ...
        public DynamicObject round(Object thisObj, Object roundToParam,
            ...
            BigInt epochNanoseconds = TemporalUtil.interpretISODateTimeOffset(getContext(), getRealm(), dtoi(roundResult.getYears()), dtoi(roundResult.getMonths()), dtoi(roundResult.getDays()),
    ...
    public abstract static class JSTemporalZonedDateTimeStartOfDay extends JSTemporalBuiltinOperation {
        ...
        public Object startOfDay(Object thisObj) {
            ...
            return JSTemporalZonedDateTime.create(getContext(), startInstant.getNanoseconds(), timeZone, calendar);
        }
    }
    ...
    public abstract static class JSTemporalZonedDateTimeToInstant extends JSTemporalBuiltinOperation {
        ...
        public Object toInstant(Object thisObj) {
            JSTemporalZonedDateTimeObject zonedDateTime = requireTemporalZonedDateTime(thisObj);
            return JSTemporalInstant.create(getContext(), zonedDateTime.getNanoseconds());
        }
    }
    ...
    public abstract static class JSTemporalZonedDateTimeGetISOFields extends JSTemporalBuiltinOperation {
        ...
        public Object getISOFields(Object thisObj) {
            ...
            DynamicObject timeZone = zdt.getTimeZone();
            DynamicObject instant = JSTemporalInstant.create(getContext(), zdt.getNanoseconds());
            DynamicObject calendar = zdt.getCalendar();
            JSTemporalPlainDateTimeObject dt = TemporalUtil.builtinTimeZoneGetPlainDateTimeFor(getContext(), timeZone, instant, calendar);
