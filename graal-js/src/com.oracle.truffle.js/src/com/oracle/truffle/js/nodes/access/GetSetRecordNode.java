...
public abstract class GetSetRecordNode extends JavaScriptBaseNode {
    ...
    @Specialization
    protected SetRecord get(Object obj,
                    @Cached IsObjectNode isObjectNode,
                    @Cached("create(SIZE, context)") PropertyGetNode getSizeNode,
                    @Cached("create(HAS, context)") PropertyGetNode getHasNode,
                    @Cached("create(KEYS, context)") PropertyGetNode getKeysNode,
                    @Cached JSToNumberNode toNumberNode,
                    @Cached JSToIntegerOrInfinityNode toIntegerOrInfinityNode,
                    @Cached JSNumberToDoubleNode numberToDoubleValueNode,
