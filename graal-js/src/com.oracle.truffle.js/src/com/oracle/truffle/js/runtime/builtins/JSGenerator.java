...
public final class JSGenerator extends JSNonProxy implements JSConstructorFactory, PrototypeSupplier {
    ...
    public static final JSGenerator INSTANCE = new JSGenerator();
    ...
    public JSDynamicObject createPrototype(JSRealm realm, JSFunctionObject constructor) {
        ...
        JSObjectUtil.putToStringTag(generatorPrototype, TO_STRING_TAG);
    ...
    public JSDynamicObject getIntrinsicDefaultProto(JSRealm realm) {
        return realm.getGeneratorObjectPrototype();
    }
}
