...
public class DefaultDerivedConstructorSuperCallNode extends JavaScriptNode {
    ...
    @Child JavaScriptNode functionNode;
    @Child JavaScriptNode targetNode;

    protected DefaultDerivedConstructorSuperCallNode(JavaScriptNode function, JavaScriptNode target) {
        this.callNode = JSFunctionCallNode.createNewTarget();
    ...
    public Object execute(VirtualFrame frame) {
        Object superFunction = functionNode.execute(frame);
    ...
    protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
        return create(cloneUninitialized(functionNode, materializedTags), cloneUninitialized(targetNode, materializedTags));
    }
