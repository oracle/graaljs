...
public class DecoratorListEvaluationNode extends JavaScriptNode {
    ...
    @Children private JavaScriptNode[] decorators;
    ...
    public Object[] execute(VirtualFrame frame) {
        Object[] values = new Object[decorators.length];
        for (int i = 0; i < decorators.length; i++) {
            Object maybeDecorator = decorators[i].execute(frame);
            values[decorators.length - i - 1] = maybeDecorator;
        }
        return values;
    }
}
