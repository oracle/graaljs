...
public abstract class AbstractContiguousDoubleArray extends AbstractDoubleArray {
    ...
    protected AbstractContiguousDoubleArray(int integrityLevel, DynamicArrayCache cache) {
        super(integrityLevel, cache);
    }

    @Override
    public double getInBoundsFastDouble(DynamicObject object, int index, boolean condition) {
        return getArray(object, condition)[(int) (index - getIndexOffset(object, condition))];
    }

    @Override
    public void setInBoundsFast(DynamicObject object, int index, double value, boolean condition) {
        getArray(object, condition)[(int) (index - getIndexOffset(object, condition))] = value;
