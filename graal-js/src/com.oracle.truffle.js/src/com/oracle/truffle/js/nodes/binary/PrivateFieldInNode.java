...
public abstract class PrivateFieldInNode extends JSBinaryNode {
    ...
    protected boolean doInstance(HiddenKey needle, JSObject haystack,
        ...
        return containsKey.execute(haystack, needle);
    }
    ...
    protected boolean doFallback(Object needle, Object haystack,
    ...
    protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
        return PrivateFieldInNode.create(cloneUninitialized(leftNode, materializedTags), cloneUninitialized(rightNode, materializedTags));
    }
}
