...
/**
 * Contains built-ins for {@linkplain JSDisplayNames} function (constructor).
 */
public final class DisplayNamesFunctionBuiltins extends JSBuiltinsContainer.SwitchEnum<DisplayNamesFunctionBuiltins.DisplayNamesFunction> {
    ...
    public enum DisplayNamesFunction implements BuiltinEnum<DisplayNamesFunction> {
        ...
        DisplayNamesFunction(int length) {
            this.length = length;
        }
