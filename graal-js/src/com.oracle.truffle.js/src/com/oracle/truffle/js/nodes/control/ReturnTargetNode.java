...
public class ReturnTargetNode extends JavaScriptNode {
    ...
    protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
        return new ReturnTargetNode(cloneUninitialized(body, materializedTags));
    }
    ...
    public static class FrameReturnTargetNode extends ReturnTargetNode {
        ...
        @Override
        protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
            return new FrameReturnTargetNode(cloneUninitialized(body, materializedTags), cloneUninitialized(returnValue, materializedTags));
        }
    }
}
