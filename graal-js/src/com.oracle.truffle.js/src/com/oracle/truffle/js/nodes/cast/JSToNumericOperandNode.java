...
/**
 * Converts a value to a numeric 'operand', which is a preliminary step when invoking an overloaded
 ...
 * overloaded operators, it is coerced to a number using ToNumeric.
 */
public abstract class JSToNumericOperandNode extends JavaScriptBaseNode {
    ...
    @Child JSToNumericNode toNumericNode;

    protected JSToNumericOperandNode() {
