...
// getISOFields(0),
    ...
    protected Object createNode(JSContext context, JSBuiltin builtin, boolean construct, boolean newTarget, TemporalPlainMonthDayPrototype builtinEnum) {
        switch (builtinEnum) {
// case add:
// return JSTemporalPlainMonthDayAddNodeGen.create(context, builtin,
// args().withThis().fixedArgs(1).createArgumentNodes(context));
// case subtract:
// return JSTemporalPlainMonthDaySubtractNodeGen.create(context, builtin,
// args().withThis().fixedArgs(1).createArgumentNodes(context));
// case with:
// return JSTemporalPlainMonthDayWithNodeGen.create(context, builtin,
// args().withThis().fixedArgs(2).createArgumentNodes(context));
// case until:
// return JSTemporalPlainMonthDayUntilNodeGen.create(context, builtin,
// args().withThis().fixedArgs(2).createArgumentNodes(context));
// case since:
// return JSTemporalPlainMonthDaySinceNodeGen.create(context, builtin,
// args().withThis().fixedArgs(2).createArgumentNodes(context));
// case round:
// return JSTemporalPlainMonthDayRoundNodeGen.create(context, builtin,
// args().withThis().fixedArgs(1).createArgumentNodes(context));
// case equals:
// return JSTemporalPlainMonthDayEqualsNodeGen.create(context, builtin,
// args().withThis().fixedArgs(1).createArgumentNodes(context));
// case toPlainDateMonthDay:
// return JSTemporalPlainMonthDayToPlainDateMonthDayNodeGen.create(context, builtin,
// args().withThis().fixedArgs(1).createArgumentNodes(context));
// case toZonedDateMonthDay:
// return JSTemporalPlainMonthDayToZonedDateMonthDayNodeGen.create(context, builtin,
// args().withThis().fixedArgs(1).createArgumentNodes(context));
// case getISOFields:
