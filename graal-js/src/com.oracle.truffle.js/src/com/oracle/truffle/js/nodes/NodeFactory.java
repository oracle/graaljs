...
public class NodeFactory {
    ...
    public JavaScriptNode createBlockScope(JavaScriptNode block, JSFrameSlot blockScopeSlot, FrameDescriptor blockFrameDescriptor, JSFrameSlot parentSlot,
                    boolean functionBlock, boolean captureFunctionFrame, boolean generatorFunctionBlock, int frameStart, int frameEnd) {
        return BlockScopeNode.create(block, blockScopeSlot, blockFrameDescriptor, parentSlot, functionBlock, captureFunctionFrame, generatorFunctionBlock, frameStart, frameEnd);
    }
