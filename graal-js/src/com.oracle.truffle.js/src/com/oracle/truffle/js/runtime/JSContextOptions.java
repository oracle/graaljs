...
public final class JSContextOptions {
    ...
    private void cacheOptions(SandboxPolicy sandboxPolicy) {
        ...
        this.iteratorHelpers = getEcmaScriptVersion() >= JSConfig.ECMAScript2018 &&
                        (this.asyncIteratorHelpers || readBooleanOption(ITERATOR_HELPERS, JSConfig.ECMAScript2025) || (v8CompatibilityMode && !ITERATOR_HELPERS.hasBeenSet(optionValues)));
        ...
        this.importAttributes = readBooleanOption(IMPORT_ATTRIBUTES, JSConfig.ECMAScript2025) || (v8CompatibilityMode && !IMPORT_ATTRIBUTES.hasBeenSet(optionValues));
        this.importAssertions = readBooleanOption(IMPORT_ASSERTIONS);
        this.jsonModules = readBooleanOption(JSON_MODULES, JSConfig.ECMAScript2025) || (v8CompatibilityMode && !JSON_MODULES.hasBeenSet(optionValues));
