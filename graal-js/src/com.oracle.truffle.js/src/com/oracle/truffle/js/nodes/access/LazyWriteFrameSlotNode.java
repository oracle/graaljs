...
public abstract class LazyWriteFrameSlotNode extends JavaScriptNode implements WriteNode {
    ...
    private static final class LazyWriteFrameSlotUninitNode extends LazyWriteFrameSlotNode {
                    ...
                    if (blockScopeMaybe instanceof Frame) {
                        ...
                        for (int scopeLevel = 0;; scopeLevel++) {
                            ...
                            if (slot != null) {
                                ...
                                JSWriteFrameSlotNode resolved = JSWriteFrameSlotNode.create(slot, scopeFrameNode, rhs, outerFrameDescriptor, JSFrameUtil.hasTemporalDeadZone(slot));
        ...
        protected JavaScriptNode copyUninitialized(Set<Class<? extends Tag>> materializedTags) {
            return new LazyWriteFrameSlotUninitNode(identifier, cloneUninitialized(rhs, materializedTags));
        }
    }
}
