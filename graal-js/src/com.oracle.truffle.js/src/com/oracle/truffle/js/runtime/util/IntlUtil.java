...
public final class IntlUtil {
    ...
    public static final TruffleString KEY_CALENDAR = TemporalConstants.CALENDAR;
    ...
    public static final TruffleString KEY_DAY = TemporalConstants.DAY;
    ...
    public static final TruffleString KEY_ERA = TemporalConstants.ERA;
    ...
    public static final TruffleString KEY_FRACTIONAL_SECOND_DIGITS = TemporalConstants.FRACTIONAL_SECOND_DIGITS;
    public static final TruffleString KEY_GRANULARITY = Strings.constant(GRANULARITY);
    public static final TruffleString KEY_HOUR = TemporalConstants.HOUR;
    ...
    public static final TruffleString KEY_MINUTE = TemporalConstants.MINUTE;
    public static final TruffleString KEY_MONTH = TemporalConstants.MONTH;
    ...
    public static final TruffleString KEY_ROUNDING_INCREMENT = TemporalConstants.ROUNDING_INCREMENT;
    public static final TruffleString KEY_ROUNDING_MODE = TemporalConstants.ROUNDING_MODE;
    ...
    public static final TruffleString KEY_SECOND = TemporalConstants.SECOND;
    ...
    public static final TruffleString KEY_TIME_ZONE = TemporalConstants.TIME_ZONE;
    public static final TruffleString KEY_TIME_ZONE_NAME = TemporalConstants.TIME_ZONE_NAME;
    ...
    public static final TruffleString KEY_UNIT = TemporalConstants.UNIT;
    ...
    public static final TruffleString KEY_YEAR = TemporalConstants.YEAR;
