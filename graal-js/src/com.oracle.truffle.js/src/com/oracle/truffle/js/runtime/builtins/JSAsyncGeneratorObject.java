...
public final class JSAsyncGeneratorObject extends JSNonProxyObject {
    ...
    public void setAsyncGeneratorContext(MaterializedFrame asyncGeneratorContext) {
        this.asyncGeneratorContext = asyncGeneratorContext;
    }

    public CallTarget getAsyncGeneratorTarget() {
        return asyncGeneratorTarget;
    }

    public void setAsyncGeneratorTarget(CallTarget asyncGeneratorTarget) {
        this.asyncGeneratorTarget = asyncGeneratorTarget;
    }
    ...
    public void setAsyncGeneratorQueue(ArrayDeque<AsyncGeneratorRequest> asyncGeneratorQueue) {
        this.asyncGeneratorQueue = asyncGeneratorQueue;
    }
