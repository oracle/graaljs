 ...
 *
 * @see JSRuntime#toDisplayString(Object, boolean, ToDisplayStringFormat)
 */
public final class ToDisplayStringFormat {
    ...
    public boolean includeArrayLength() {
        return includeArrayLength;
    }

    public ToDisplayStringFormat withQuoteString(boolean quote) {
        return new ToDisplayStringFormat(maxDepth, maxElements, quote, includeArrayLength);
    }
