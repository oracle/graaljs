...
var sq = squareTest.then(function(value) { return module.square(value.t); });

var dg = diagTest.then(value => module.diag(value.x, value.y));
var st = sqrtTest.then(value => module.sqrt(value.v));
