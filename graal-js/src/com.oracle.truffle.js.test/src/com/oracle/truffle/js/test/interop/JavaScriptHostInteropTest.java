    ...
    public void testArgumentTypeError() {
        ...
        try (Context context = Context.newBuilder(ID).allowHostAccess(HostAccess.ALL).build()) {
            ...
            expectedException = e -> {
                ...
                assertThat(e.getMessage(), e.getMessage(), containsString("Cannot convert 'abc'"));
                assertThat(e.getMessage(), e.getMessage(), containsString("to Java type 'java.util.Map[]'"));
            };
            ...
            expectedException = e -> {
                assertThat(e.getMessage(), e.getMessage(), containsString(expectedClassName));
                assertThat(e.getMessage(), e.getMessage(), containsString("write"));
                assertThat(e.getMessage(), e.getMessage(), containsString("Cannot convert '6'"));
                assertThat(e.getMessage(), e.getMessage(), containsString("to Java type 'java.lang.String'"));
            };
