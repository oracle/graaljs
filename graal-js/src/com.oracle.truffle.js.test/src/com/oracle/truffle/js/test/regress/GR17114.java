    ...
    public void rethrowHostException() {
        try (Context context = JSTest.newContextBuilder().build()) {
            ...
            try {
                ...
                assertSame(RuntimeException.class, e.asHostException().getClass());
                StackFrame firstStackFrame = e.getPolyglotStackTrace().iterator().next();
                assertThat(firstStackFrame.getRootName(), containsString("iThrow"));
            }
        }
    }

    private static RuntimeException iThrow() {
