...
public class GR54723 {

    @Test
    public void testIt() {
        try (Context ctx = JSTest.newContextBuilder().build()) {
            ProxyObject internal = ProxyObject.fromMap(Map.of("value", "internalValue"));
            ProxyExecutable proxyExecutable = args -> Value.asValue("test");
            Map<String, Object> val = Map.of("func", proxyExecutable, "object", internal);
            ProxyObject p = ProxyObject.fromMap(val);
