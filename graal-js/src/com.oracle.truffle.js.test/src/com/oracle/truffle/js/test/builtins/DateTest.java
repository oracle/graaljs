...
/**
 * Tests for the Date builtin.
 */
public class DateTest extends JSTest {

    @Test
    public void testDateParse() {
        assertEquals(true, testHelper.run("var date = Date.parse('2022-12-15T12:34:56'); 1670000000000 <= date && date <= 1672000000000;"));

        // GR-36932, Github #558
        assertEquals(true, testHelper.run("Number.isNaN(Date.parse('292278995'))"));
        assertEquals(true, testHelper.run("Number.isNaN(Date.parse('292278996'))"));
