            ...
            if (!JSTruffleOptions.SubstrateVM) {
                try {
                    if (testMapClass == null) {
                        testMapClass = Class.forName("com.oracle.truffle.js.test.internal.interop.object.ForeignTestMap");
                    }
    ...
    abstract static class PolyglotCreateForeignDynamicObjectNode extends JSBuiltinNode {
        ...
        protected Object createForeignDynamicObject() {
            if (!JSTruffleOptions.SubstrateVM) {
                try {
                    if (testMapClass == null) {
                        testMapClass = Class.forName("com.oracle.truffle.js.test.internal.interop.object.ForeignDynamicObject");
                    }
