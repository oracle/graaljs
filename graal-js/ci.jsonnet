...

{
  ...
  builds: [
    ...
    graalJs + common.jdk16 + common.gate   + common.linux          + nativeImageSmokeTest                                                     + {name: 'js-gate-native-image-smoke-test-jdk16-linux-amd64'},
    ...
    // jdk 15 - linux
    graalJs + common.jdk16 + common.gate   + common.linux          + common.gateTags           + {environment+: {TAGS: 'default'}}            + {name: 'js-gate-default-jdk16-linux-amd64'},
