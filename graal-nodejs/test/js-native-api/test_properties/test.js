...
const readonlyErrorRE =
  /^TypeError: Cannot assign to read only property '.*' of object '#<Object>'$|^TypeError: ".*" is not a writable property of|^TypeError: Cannot redefine property .* which has only a getter$|^TypeError: Cannot set property .* of .* which has only a getter$/;
