...

{
  ...
  builds: [
    ...
    graalNodeJs + common.jdk8  + common.gate      + common.darwin         + common.gateTags             + {environment+: {TAGS: 'all'}}                                             + {name: 'nodejs-gate-jdk8-darwin-amd64', timelimit: '55:00'},
    graalNodeJs + common.jdk11 + common.gate      + common.darwin         + common.gateTags             + {environment+: {TAGS: 'all'}}                                             + {name: 'nodejs-gate-jdk11-darwin-amd64', timelimit: '55:00'},
...
//    graalNodeJs + common.jdk17 + common.gate      + common.windows_jdk17  + common.gateTags             + {environment+: {TAGS: 'windows'}}                                         + {name: 'nodejs-gate-jdk17-windows-amd64'},
    ...
    graalNodeJs + common.jdk11 + common.gate      + common.darwin         + gateSubstrateVm                                                                                         + {name: 'nodejs-gate-substratevm-jdk11-darwin-amd64', timelimit: '55:00'},
