...

{
  ...
  builds: [
    ...
    graalNodeJs + common.jdk8  + buildTruffleTip + buildAddons      + testNodeTruffleTip + {environment+: {SUITE: 'addons', PART: '-r0,1'}}        + common.gate + common.windows_vs2010 + {name: 'nodejs-gate-addons-graal-tip-jdk8-windows-amd64'},
    graalNodeJs + common.jdk8  + buildTruffleTip + buildNodeAPI     + testNodeTruffleTip + {environment+: {SUITE: 'node-api', PART: '-r0,1'}}      + common.gate + common.windows_vs2010 + {name: 'nodejs-gate-node-api-graal-tip-jdk8-windows-amd64'},
    graalNodeJs + common.jdk8  + buildTruffleTip + buildJSNativeAPI + testNodeTruffleTip + {environment+: {SUITE: 'js-native-api', PART: '-r0,1'}} + common.gate + common.windows_vs2010 + {name: 'nodejs-gate-js-native-api-graal-tip-jdk8-windows-amd64'},
    graalNodeJs + common.jdk8  + buildTruffleTip                    + testNodeTruffleTip + {environment+: {SUITE: 'async-hooks', PART: '-r0,1'}}   + common.gate + common.windows_vs2010 + {name: 'nodejs-gate-async-hooks-graal-tip-jdk8-windows-amd64'},
    graalNodeJs + common.jdk8  + buildTruffleTip                    + testNodeTruffleTip + {environment+: {SUITE: 'es-module', PART: '-r0,1'}}     + common.gate + common.windows_vs2010 + {name: 'nodejs-gate-es-module-graal-tip-jdk8-windows-amd64'},
    graalNodeJs + common.jdk8  + buildTruffleTip                    + testNodeTruffleTip + {environment+: {SUITE: 'sequential', PART: '-r0,1'}}    + common.gate + common.windows_vs2010 + {name: 'nodejs-gate-sequential-graal-tip-jdk8-windows-amd64'},
    graalNodeJs + common.jdk8  + buildTruffleTip                    + testNodeTruffleTip + {environment+: {SUITE: parallelNoHttp2, PART: '-r0,5'}} + common.gate + common.windows_vs2010 + {name: 'nodejs-gate-parallel-1-graal-tip-jdk8-windows-amd64'},
    graalNodeJs + common.jdk8  + buildTruffleTip                    + testNodeTruffleTip + {environment+: {SUITE: parallelNoHttp2, PART: '-r1,5'}} + common.gate + common.windows_vs2010 + {name: 'nodejs-gate-parallel-2-graal-tip-jdk8-windows-amd64'},
    graalNodeJs + common.jdk8  + buildTruffleTip                    + testNodeTruffleTip + {environment+: {SUITE: parallelNoHttp2, PART: '-r2,5'}} + common.gate + common.windows_vs2010 + {name: 'nodejs-gate-parallel-3-graal-tip-jdk8-windows-amd64'},
    graalNodeJs + common.jdk8  + buildTruffleTip                    + testNodeTruffleTip + {environment+: {SUITE: parallelNoHttp2, PART: '-r3,5'}} + common.gate + common.windows_vs2010 + {name: 'nodejs-gate-parallel-4-graal-tip-jdk8-windows-amd64'},
    graalNodeJs + common.jdk8  + buildTruffleTip                    + testNodeTruffleTip + {environment+: {SUITE: parallelNoHttp2, PART: '-r4,5'}} + common.gate + common.windows_vs2010 + {name: 'nodejs-gate-parallel-5-graal-tip-jdk8-windows-amd64'},
