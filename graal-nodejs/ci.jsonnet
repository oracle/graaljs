...

{
  ...
  builds: [
    ...
    graalNodeJs + common.jdk8  + common.gate      + common.darwin         + common.gateTags             + {environment+: {TAGS: 'all'}}                                             + {name: 'nodejs-gate-jdk8-darwin-amd64', timelimit: '40:00'},
    graalNodeJs + common.jdk11 + common.gate      + common.darwin         + common.gateTags             + {environment+: {TAGS: 'all'}}                                             + {name: 'nodejs-gate-jdk11-darwin-amd64', timelimit: '40:00'},
