...
#ifndef GRAAL_STACK_TRACE_INL_H_
...
inline GraalStackTrace* GraalStackTrace::Allocate(GraalIsolate* isolate, jobject stack_trace) {
    return new GraalStackTrace(isolate, stack_trace);
}

#endif /* GRAAL_STACK_TRACE_INL_H_ */
