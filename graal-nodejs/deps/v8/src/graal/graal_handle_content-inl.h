...
#ifndef GRAAL_HANDLE_CONTENT_INL_H_
#define GRAAL_HANDLE_CONTENT_INL_H_

#include "graal_handle_content.h"
#include "graal_isolate.h"
#include <stdio.h>

inline GraalHandleContent::GraalHandleContent(GraalIsolate* isolate, jobject java_object) :
isolate_(isolate),
