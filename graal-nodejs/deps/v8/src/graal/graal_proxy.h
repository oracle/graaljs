...
public:
    inline static GraalProxy* Allocate(GraalIsolate* isolate, jobject java_proxy);
    inline static GraalProxy* Allocate(GraalIsolate* isolate, jobject java_proxy, void* placement);
